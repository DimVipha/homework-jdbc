...
public class UserRepoImpl implements UserRepo{
    ...
    public List<User> getAllUsers() {
        ...
        try (Connection connection = DriverManager.getConnection(
                PropertiesLoader.properties.getProperty("db_url"),
                PropertiesLoader.properties.getProperty("db_username"),
                PropertiesLoader.properties.getProperty("db_password"));
             )
        {
...
//            return userList;
    ...
    public void createUser(User user) {
                ...
                )
        {
            ...
            preparedStatement.setBoolean(3, user.getDeleted());
            preparedStatement.setString(4, user.getPassword());
            preparedStatement.setBoolean(5, user.getVerified());
